...
CustomerTrustedSink_node1748105752041 = glueContext.getSink(path="s3://stedi-datalake-terraform-kr/customer_trusted/", connection_type="s3", updateBehavior="UPDATE_IN_DATABASE", partitionKeys=[], enableUpdateCatalog=True, transformation_ctx="CustomerTrustedSink_node1748105752041")
