...
AccelerometerTrustedSink_node1748111644064 = glueContext.getSink(path="s3://stedi-datalake-terraform-kr/accelerometer_trusted/", connection_type="s3", updateBehavior="UPDATE_IN_DATABASE", partitionKeys=[], enableUpdateCatalog=True, transformation_ctx="AccelerometerTrustedSink_node1748111644064")
