...
CustomerCuratedSink_node1748118922415 = glueContext.getSink(path="s3://stedi-datalake-terraform-kr/customer_curated/", connection_type="s3", updateBehavior="UPDATE_IN_DATABASE", partitionKeys=[], enableUpdateCatalog=True, transformation_ctx="CustomerCuratedSink_node1748118922415")
